-- Separa los indicadores para que ninguna persona se cuente dos veces:
-- activos = más de 3 días; por vencer = entre 0 y 3 días.
...
select
  (select count(*) from public.clientes, limites
    where activo = true
      and fecha_vencimiento > limites.hoy + 3) as socios_activos,
...
comment on view public.v_dashboard_estadisticas is
  'Indicadores excluyentes: activos con más de 3 días, próximos 0 a 3 días y vencidos de 1 a 30 días.';
