-- Cuenta como vencidos a quienes tienen entre 1 y 30 días de atraso.
-- Los indicadores se recalculan en cada consulta usando el día argentino.
...
comment on view public.v_dashboard_estadisticas is
  'Indicadores dinámicos: activos, próximos 3 días, vencidos de 1 a 30 días, ingresos y altas del mes calendario.';
