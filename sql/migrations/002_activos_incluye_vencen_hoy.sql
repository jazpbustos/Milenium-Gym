-- Una cuota que vence hoy todavía se considera activa.
...
comment on view public.v_dashboard_estadisticas is
  'Indicadores dinámicos: cuotas activas incluyendo hoy, próximos 3 días, vencidos de 1 a 30 días, ingresos y altas del mes.';
